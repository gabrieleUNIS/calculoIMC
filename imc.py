...
botao_calcular = tk.Button(janela,height=1,width=10, text="Calcular", command=calcular_imc)

# Criando o botão limpar
botao_reiniciar = tk.Button(janela,height=1,width=10, text="Reiniciar", command=limpar_campos)

# Criando o botão sair
botao_sair = tk.Button(janela,height=1,width=10, text="Sair", command=janela.quit)

# Criando o label para exibir o resultado
label_resultado = tk.Label(janela,height=5,width=15, text="", font=("Helvetica", 12))
